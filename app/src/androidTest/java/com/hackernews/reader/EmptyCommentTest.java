...
import static com.hackernews.reader.CommentActivity.COMMENT_LIST;
...
public class EmptyCommentTest {
    ...
    @Rule
    public final ActivityTestRule<CommentActivity> activityTestRule = new ActivityTestRule<>(CommentActivity.class, true, false);
